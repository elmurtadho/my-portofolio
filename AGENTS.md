...
- Workspace ID: `b2e169f4-a4de-44fb-8f0a-ad0b522f149c`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/b2e169f4-a4de-44fb-8f0a-ad0b522f149c.
...
2. `npx ngodingpakeai connect --workspace b2e169f4-a4de-44fb-8f0a-ad0b522f149c --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/b2e169f4-a4de-44fb-8f0a-ad0b522f149c. Only pass on links the CLI actually printed — never assemble one from an id yourself.
